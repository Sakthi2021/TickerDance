...
const Card = ({ color, title, children, examples }) => (
  <div style={{
    ...
    <p style={{ color: '#666', fontSize: 11, lineHeight: 1.6, margin: '4px 0' }}>
      {children}
    </p>
        ...
        >
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div style={{ color: C.accent, fontFamily: "'Orbitron', monospace", fontSize: 14, letterSpacing: 4 }}>MARKET GLOSSARY</div>
              <button
                onClick={() => setShowGlossary(false)}
                style={{
                  background: 'transparent',
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginTop: 24 }}>
              <Card color={C.accent} title="VOLATILITY">How wildly a stock price swings daily. High volatility means unpredictable price movements. In TickerDance, high volatility = faster dancing and more intense music.</Card>
              <Card color={C.secondary} title="MOMENTUM">The direction and strength of a stock price movement over time. Positive momentum means the stock is rising. In TickerDance, momentum determines dancer color — green for bullish, orange for bearish, blue for sideways.</Card>
              <Card color={C.accent} title="VOLUME">The number of shares traded in a given period. High volume means many investors are actively buying or selling. In TickerDance, volume controls the intensity and energy of the performance.</Card>
              <Card color={C.accent} title="TREND">The overall direction of price movement over the selected period. In TickerDance, trend determines the musical scale — major for bullish, minor for bearish.</Card>
              <Card color={C.secondary} title="ENERGY">A combined score from volatility and volume. High energy stocks have both high volatility and high trading activity. In TickerDance, energy controls particle density and pulse ring intensity.</Card>
              <Card color={C.accent} title="BPM">Beats Per Minute — the tempo of the dance and music. Directly calculated from volatility. Coca-Cola dances at ~40 BPM. GameStop can reach 180 BPM.</Card>
              <Card color={C.secondary} title="CHOREOGRAPHY SEED">A unique identifier generated from company, date range and dance style. Same inputs always produce the same seed — the market data is the choreographer, not random chance.</Card>
            </div>
          </div>
        </div>
      )}
